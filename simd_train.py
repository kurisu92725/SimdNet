...
import os
from simdnet import Simd
from torch_geometric.nn.acts import swish
from graphdataset import dataset_for_pyg,collate_6
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--gpuid', type=str, default='0', help="GPU id for training model, else use CPU")
    argparser.add_argument('--lr', type=float, default=5e-4, help="Learning rate")
    argparser.add_argument('--epochs', type=int, default=200, help="Number of epochs in total")
    ...
    argparser.add_argument('--train_valid_path', type=str, default='../PLA_data_pre/data11/refine',help='path of training set ')
    argparser.add_argument('--train_valid_name_path', type=str, default='../PLA_data_pre/data11/refine_name_pointer.pkl',help='path of training name')
    argparser.add_argument('--test_path', type=str, default='../PLA_data_pre/data11/core',help='path of testing set ')
    argparser.add_argument('--test_name_path', type=str, default='../PLA_data_pre/data11/core_name_pointer.pkl', help='path of testing name')
    argparser.add_argument('--label_path', type=str, default='./pdb_2016_labels.pkl',help='label path')

    argparser.add_argument('--saving_path', type=str, default='./netpar_result/simd_add_atom_cls_general(epoch200)', help='saving path')
