...
from graphdataset import dataset_for_pyg,collate_6,PDBbind_2016_complex
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--test_path', type=str, default='./examples/core',help='path of testing set ')
    argparser.add_argument('--test_name_path', type=str, default='./examples/core_name_pointer.pkl', help='path of testing name')
    argparser.add_argument('--label_path', type=str, default='./examples/pdb_2016_labels.pkl',help='label path')

    argparser.add_argument('--saving_path', type=str, default='./examples', help='saving path')##need change
    ...
    params_path = save_files + '/net_params'
    ...
    result_file = save_files+'/finalresult/simd_core_2016_result.pkl'
    ...
    plt.text(1.4, 12, r'$R_{p}=$'+pccs[0], fontsize=20)
    # plt.legend(loc='best')
